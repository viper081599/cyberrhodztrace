#!/bin/bash
# Hound v 0.2
# Powered by CyberRhodz
# visit https://web.facebook.com/profile.php?id=100063776797211
...
printf '   ██   ██ ██   ██  █████  ██████  ███████\n\n'
printf '\e[1;31m       ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀\n'
printf " \e[1;93m      CyberRhodz Ver 0.2\e[0m \n"
printf "\e[1;90m Information gathering tool.\e[0m \n"
printf "\n"
}
